...
- 安装来源：默认固定到已验证的 AlphaSift 适配层 commit：`ALPHASIFT_INSTALL_SPEC=git+https://github.com/ZhuLinsen/alphasift.git@b2ca66dd47001b9a09890cfe21c2b18c7219ccf5`；桌面发布包在构建阶段预置该依赖，运行时开关只控制是否启用。
